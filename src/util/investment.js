...
export function calculateInvestmentResults({
  ...
  for (let i = 0; i < duration; i++) {
    ...
    annualData.push({
      ...
      totalInterest: formatter.format(totalInterest), // total interest earned up to this year
      investedCapital: formatter.format(totalInvestedCapital), // total investment added up to this year
    });
  }
