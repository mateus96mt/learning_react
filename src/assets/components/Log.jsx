                ...
                <table style={{ border: "1px solid black", borderCollapse: "collapse", width: "auto" }}>
                    ...
                    <tbody>
                        {(gamelog || []).map((entry, index) => (
                            <tr key={index}>
                                <td style={{ border: "1px solid black", padding: "8px", color: "black", textAlign: "center" }}>{index + 1}</td>
                                <td style={{ border: "1px solid black", padding: "8px", color: "black" }}>{entry.playerName}</td>
                                <td style={{ border: "1px solid black", padding: "8px", color: "black", textAlign: "center" }}>{entry.turnMark}</td>
